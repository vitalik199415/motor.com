<div class="main">
    <div class="main-inner">
        <div class="container">
            <form action="<?=URL::set_url('admin/categories/save/').@$id;?>" method="post" id="add_edit_form" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="span12">
                    <div class="widget action-btn">
                        ...
                        <div class="widget-content form-actions" align="rig" >
                            <a href="<?=URL::set_url('admin/categories');?>" class="btn btn-info"><i class="icon-arrow-left"></i> Назад</a>
                            <button type="submit" href="<?=URL::set_url('admin/categories/save');?>" class="btn btn-success"><i class="icon-save"></i> Сохранить</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="widget-content">
                                <fieldset>
                                    <div class="control-group">
                                        <label class="control-label" for="lang">Родительская категория: </label>
                                        <div class="controls">
                                            <?=Form::select('main[id_parent]', @$categories, @$main['id_parent'], array('class' => 'span10', 'id' => 'parent'));?>
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
                                    <div class="control-group">
                                        <label class="control-label" for="url">URL категории: </label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="img">Изображение категории: </label>
                                        <div class="controls">
                                            <div id="files"><input name="image" type="file" class="span10" id="img"> <!--<a class="icon-plus" id="add_file" title="Добавить изображение"></a>--></div>
                                            <img src="<?=@$main['image'];?>">
                                        </div> <!-- /controls -->
                                    </div> <!-- /control-group -->
                                    <div class="control-group">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="<?=$key;?>">
                                            <fieldset>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="description">Описание категории: </label>
                                                    <div class="controls">
