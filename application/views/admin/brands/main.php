                ...
                <div class="span12">
                    <div class="widget action-btn">
                        ...
                        <div class="widget-content" align="rig" >
                            <a href="<?=URL::set_url('admin/brands/add');?>" class="btn btn-info"><i class="icon-plus"></i> Добавить</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="widget-content">
                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <? if(isset($main))
                                    foreach($main as $row):?>
                                        <tr >
                                            <td style="text-align: center;"> <?=$row['id_car_brands']?> </td>
                                            ...
                                            <td class="td-actions" style="text-align: center;">
                                                <a href="<?=URL::set_url('admin/brands/edit/'.$row['id_car_brands']);?>" class="btn btn-small btn-success"><i class="btn-icon-only icon-edit"> </i></a>
                                                <a href="<?=URL::set_url('admin/brands/delete/'.$row['id_car_brands']);?>" class="btn btn-danger btn-small" id="delete"><i class="btn-icon-only icon-remove"> </i></a>
                                            </td>
                                        </tr>
                                    <? endforeach; ?>
                                </tbody>
